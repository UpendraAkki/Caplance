      ...
      <div className={`relative z-10 max-w-4xl text-center space-y-6 transition-all duration-700 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="flex justify-center">
          <span className="inline-flex items-center gap-2 px-3 py-1 text-xs font-medium rounded-full bg-muted text-primary">
            ...
            Available for flexible work • $45-50/hour
            <Loader className="h-3 w-3 animate-spin text-primary" />
          </span>
        </div>
        
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-medium tracking-tighter text-balance text-foreground">
          Vibe Coder for <span className="text-primary">innovative</span> companies
        </h1>
        
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-balance">
          I'm Upendra Gariminti, a Vibe Coder and recent BBA graduate specializing in Entrepreneurship. Expert in No-Code development, E-commerce, and AI solutions for modern businesses.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6 items-center">
          <Button 
            ...
            onClick={() => window.open('mailto:upendra@leadkamp.com?subject=Work Opportunity - $45-50 per hour', '_blank')}
          >
            Hire Me Now
          </Button>
          <Button 
        ...
        <div className="pt-6 text-sm text-muted-foreground">
          BBA Graduate • Entrepreneurship Specialist • No-Code Expert • Flexible Schedule
        </div>
      </div>
          ...
          <div className="bg-card backdrop-blur-md w-full">
            <div className="flex items-center justify-between p-4 border-b border-border">
              <div className="flex items-center gap-4">
                ...
                <span className="text-foreground font-medium">Recent Projects Dashboard</span>
              </div>
            ...
            <div className="flex h-[600px] overflow-hidden">
              ...
              <div className="w-64 border-r border-border p-4 space-y-4 hidden md:block bg-card">
                <div className="space-y-2">
                  <div className="text-xs text-muted-foreground uppercase">Current Focus</div>
                ...
                <div className="space-y-2 pt-4">
                  <div className="text-xs text-muted-foreground uppercase">Live Projects</div>
                  <div className="space-y-1">
                    <div className="flex items-center gap-3 px-3 py-2 rounded-md text-muted-foreground hover:bg-muted/50">
              ...
              <div className="flex-1 p-4 bg-background overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-6 min-w-0">
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <span className="text-xs bg-muted px-2 py-1 rounded-full text-muted-foreground">4 Live</span>
                  </div>
